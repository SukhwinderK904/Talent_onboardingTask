...
namespace OnboardingTalentProject.Controllers
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        public SalesController(Talent_ONBOARDINGContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Sales>> DeleteSales(int id)
        {
            ...
            var sales = await _context.Sales.Include(c => c.Customer).Include(p => p.Product).Include(s => s.Store).FirstOrDefaultAsync(s => s.SalesId == id);
            if (sales == null)
            {
                return NotFound();
            }
